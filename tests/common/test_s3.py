...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def test_list_files_in_prefix_ok(self):
        ...
        self.assertEqual(len(list_result), 2) #return list has 2 items
        self.assertIn(key1_exp, list_result) #is key1 in the list results
        self.assertIn(key2_exp, list_result) #is key2 in the list results
        # Cleanup after test
